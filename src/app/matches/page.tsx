                ...
                <div className="flex flex-col items-center justify-center text-center py-16">
                    <Card className="max-w-md w-full bg-card/50 border-primary/40 p-8 rounded-2xl shadow-2xl shadow-primary/20 box-glow-primary transition-all hover:shadow-primary/30">
                        <CardHeader className="p-0 items-center">
                            ...
                            <CardDescription className="text-lg mt-2 max-w-xs">
                                No matches yet. It's time to make your move and claim the top spot!
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="p-0 mt-8">
                            <Button asChild size="lg" className="font-headline text-lg w-full">
